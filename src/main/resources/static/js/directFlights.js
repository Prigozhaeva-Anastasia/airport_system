window.onload=function() {
    ...
    applyBtn.addEventListener('click', function (event) {
        formFilter.action = '/directFlights/filterByDate?from=' + date1.value + '&to=' + date2.value;
    });
    ...
    applyBtn2.addEventListener('click', function (event) {
        formFilter2.action = '/directFlights/filterByTime?from=' + time1.value + '&to=' + time2.value;
    });
